...
static const char *fonts[]          = { font, "Fira Code Nerd Font:pixelsize=19" };
...
static const Rule rules[] = {
        ...
        {"jetbrains-webstorm",  NULL,       "splash",               0,          1,          -1},
        {"jetbrains-pycharm",   NULL,       "splash",               0,          1,          -1},
        {"zoom",                NULL,       "Settings",             1<<7,       0,          -1},
        {"zoom",                NULL,       "Zoom Meeting",         1<<7,       0,          -1},
        {"zoom",                NULL,       "Zoom - Free Account",  1<<7,       0,          -1},
        {"zoom",                NULL,       "",                     1<<7,       1,          -1},
...
//	{ MODKEY|ShiftMask,             XK_equal,  setgaps,        {.i = GAP_TOGGLE} },
	{ MODKEY,                       XK_Prior,   viewtoleft,    {0} },
	{ MODKEY,                       XK_Next,    viewtoright,   {0} },
	{ MODKEY|ShiftMask,             XK_Prior,   tagtoleft,     {0} },
	{ MODKEY|ShiftMask,             XK_Next,    tagtoright,    {0} },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
